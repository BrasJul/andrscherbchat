...
class RegisterWindow(CTk):
   def __init__(self):
       ...
       CTkLabel(self, text='sign up to lqwjejh👍', font=('Comic Sans MS', 25, 'bold')).pack(pady=40)
       self.name_entry = CTkEntry(self, placeholder_text='entername', font=('Comic Sans MS', 15, 'italic'))
       self.name_entry.pack()
       self.host_entry = CTkEntry(self, placeholder_text='localhost', font=('Comic Sans MS', 15, 'italic'))
       self.host_entry.pack(pady=15)
       self.port_entry = CTkEntry(self, placeholder_text='port (12334) ', font=('Comic Sans MS', 15, 'italic'))
       self.port_entry.pack()
       self.submit_button = CTkButton(self, text='join', command=self.start_chat, font=('Comic Sans MS', 25, 'bold', 'italic'), fg_color="violet", hover_color="purple", height=80, width=200)
...
class MainWindow(CTk):
   ...
   def add_message(self, message, img=None):
      message_frame = CTkFrame(self.chat_field, fg_color='violet')
